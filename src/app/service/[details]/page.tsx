...
export default function ServiceDetailPage(): React.JSX.Element {
  ...
  // Get service ID from params (folder is `[details]`)
  // Support both `params.details` (from folder name) and legacy `params.id`.
  const serviceId = (params?.details ?? params?.id) as string;
