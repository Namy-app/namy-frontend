  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Banner Ad */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Banner Ad (Horizontal)</h2>
          <AdUnit
        ...
        {/* Responsive Ad */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Responsive Ad (Auto)</h2>
          <AdUnit
            slot="1234567890" // Replace with your actual ad slot ID
            format="auto"
            responsive
        ...
        <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
          ...
          <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
            ...
            <li>Test ads show placeholder content (blank or test patterns)</li>
            <li>
              Remove <code>data-adtest=&quot;on&quot;</code> for production
            </li>
            <li>
